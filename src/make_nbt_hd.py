...
def main():
    ...
    ap.add_argument("--fgd-cstline", default=None,
                    help="海岸線 Cstline GML パス（実測海岸線を護岸andesiteで接地）")
    ...
    ap.add_argument("--landmarks", action="store_true",
                    help="OSM POI(社寺/駅/学校/役所/銭湯/病院)で建物を特定し専用外装を割当(要オンライン)")
    ...
    for tag, r in runs.items():
        ...
        for ttag, t_lat, t_lon, t_w, t_d, t_crop in tile_specs:
            ...
            export_to_nbt(
                ...
                landmarks_fetch=args.landmarks,
