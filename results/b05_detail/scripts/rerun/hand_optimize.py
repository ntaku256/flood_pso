...
lb=np.empty(Dd); ub=np.empty(Dd); lb[0],ub[0]=0.0,8.0; lb[1:],ub[1:]=-2.0,2.0
DMAX=10.0
...
print('\n=== HAND 基準 (d0∈[0,8], dd∈[-2,2] → depth∈[-2,10])、K=16, 5000評価, 3シード ===', flush=True)
...
json.dump(out,open('/home/ntaku/laravel-project/flood_pso/results/b05_detail/raw/hand_optimize.json','w'),indent=1)
