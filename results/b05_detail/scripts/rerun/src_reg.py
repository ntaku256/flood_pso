...
CONF=[('bbox水源・正則化なし (現行)',SRC_BBOX,0.0),
      ('実河道水源・正則化なし',SRC_DRAIN,0.0),
      ('bbox水源・λ=0.001',SRC_BBOX,0.001),
      ('bbox水源・λ=0.01',SRC_BBOX,0.01),
      ('bbox水源・λ=0.05',SRC_BBOX,0.05)]
res={}
t0=time.time()
...
json.dump(res,open('/home/ntaku/laravel-project/flood_pso/results/b05_detail/raw/src_reg.json','w'),ensure_ascii=False,indent=1,default=float)
